...
can we use RNNs to build a semantic parser?  % RJ: IMO this makes the transition to next paragraph easier
...
\newcite{luong2015rare} also proposed models for copying
