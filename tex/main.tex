...
with examples drawn from distributions that are very different from the test distribution.
...
or because they encourage the network to learn better alignments between
...
Their focus on building soft representations
